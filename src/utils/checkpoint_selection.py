...
_PROFILE_SPECS: dict[str, dict[str, Any]] = {
    "continuation": {
        ...
        "notes": [
            "把结构与停止行为作为底线，真正拉开排序的主要是乐句质量、贴合度与重复控制。",
            "FSM 可以承担一部分语法约束，因此这里的结构类指标应明显弱于听感代理指标。",
        ],
        "gates": [
        ...
        "metrics": [
            {"key": "continuation_structural_validity_rate", "weight": 0.04, "goal": "max"},
            {"key": "continuation_time_order_validity_rate", "weight": 0.03, "goal": "max"},
            {"key": "continuation_empty_bar_rate", "weight": 0.02, "goal": "min"},
            {"key": "continuation_stop_success_rate", "weight": 0.01, "goal": "max"},
            {"key": "continuation_budget_stop_rate", "weight": 0.01, "goal": "min"},
            {"key": "continuation_syntax_invalid_rate", "weight": 0.01, "goal": "min"},
            {"key": "valid_loss_from_training", "weight": 0.03, "goal": "min"},
            {"key": "phrase_coherence_score", "weight": 0.28, "goal": "max"},
            {"key": "long_context_stability_score", "weight": 0.16, "goal": "max"},
            {"key": "continuation_first_event_hit_rate", "weight": 0.12, "goal": "max"},
            {"key": "duration_bin_l1_distance", "weight": 0.10, "goal": "min"},
            {"key": "generated_event_delta_mean", "weight": 0.05, "goal": "min"},
            {"key": "continuation_event_ngram_repeat_ratio", "weight": 0.08, "goal": "min"},
            {"key": "continuation_rhythm_ngram_repeat_ratio", "weight": 0.06, "goal": "min"},
        ],
        "tie_breakers": [
    ...
    "overall": {
        ...
        "notes": [
            ...
            "这个 profile 会刻意弱化结构分，把主要权重放在音乐性代理指标上。",
        ],
        "gates": [
            {"key": "continuation_stop_success_rate", "goal": "max", "threshold": 0.20},
            {"key": "continuation_budget_stop_rate", "goal": "min", "threshold": 0.75},
        ...
        "metrics": [
            {"key": "infilling_structural_validity_rate", "weight": 0.04, "goal": "max"},
            {"key": "continuation_structural_validity_rate", "weight": 0.03, "goal": "max"},
            {"key": "continuation_time_order_validity_rate", "weight": 0.03, "goal": "max"},
            {"key": "infilling_time_order_validity_rate", "weight": 0.02, "goal": "max"},
            ...
            {"key": "valid_loss_from_training", "weight": 0.025, "goal": "min"},
            {"key": "phrase_coherence_score", "weight": 0.31, "goal": "max"},
            {"key": "long_context_stability_score", "weight": 0.19, "goal": "max"},
            {"key": "continuation_first_event_hit_rate", "weight": 0.11, "goal": "max"},
            {"key": "duration_bin_l1_distance", "weight": 0.06, "goal": "min"},
            {"key": "generated_event_delta_mean", "weight": 0.03, "goal": "min"},
            {"key": "continuation_event_ngram_repeat_ratio", "weight": 0.05, "goal": "min"},
            {"key": "continuation_rhythm_ngram_repeat_ratio", "weight": 0.03, "goal": "min"},
            {"key": "overall_event_ngram_repeat_ratio", "weight": 0.02, "goal": "min"},
            {"key": "overall_rhythm_ngram_repeat_ratio", "weight": 0.01, "goal": "min"},
        ],
        "tie_breakers": [
            ("phrase_coherence_score", "max"),
            ("long_context_stability_score", "max"),
...
def score_checkpoint_results(
    ...
    *,
    ...
    selection = {
        ...
        "selection_version": "balanced_v6_effect_first",
