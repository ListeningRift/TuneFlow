...
> **2026-05-17 更新**：本 PR 已落地「PHRASE 边界 token 引入」与「动态 window / 启发式切句机制下沉」。剩余子项（句类型 / 句关系 / 句尾收束 / 呼吸 / 重音 / 动机角色等分类头 / 句级辅助任务头 / 基于 PHRASE 的训练采样重加权）保留为后续工作。详见 `docs/superpowers/specs/2026-05-17-phrase-token-design.md` 与 `docs/superpowers/plans/2026-05-17-phrase-token.md`。
